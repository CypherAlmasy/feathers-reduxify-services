...
var reduxifyService = function reduxifyService(app, route) {
  ...
  var reducerForServiceMethod = function reducerForServiceMethod(actionType, ifLoading, isFind) {
    ...
    return _ref = {}, _defineProperty(_ref, actionType + '_' + opts.PENDING, function undefined(state, action) {
      ...
      return state.merge((_state$merge = {}, _defineProperty(_state$merge, opts.isError, null), _defineProperty(_state$merge, opts.isLoading, ifLoading), _defineProperty(_state$merge, opts.isSaving, !ifLoading), _defineProperty(_state$merge, opts.isFinished, false), _defineProperty(_state$merge, opts.data, null), _defineProperty(_state$merge, opts.queryResult, state[opts.queryResult] || null), _state$merge));
      ...
      return state.merge((_state$merge2 = {}, _defineProperty(_state$merge2, opts.isError, null), _defineProperty(_state$merge2, opts.isLoading, false), _defineProperty(_state$merge2, opts.isSaving, false), _defineProperty(_state$merge2, opts.isFinished, true), _defineProperty(_state$merge2, opts.data, !isFind ? (0, _immutable.fromJS)(action.payload) : null), _defineProperty(_state$merge2, opts.queryResult, isFind ? (0, _immutable.fromJS)(action.payload) : state[opts.queryResult] || null), _state$merge2));
      ...
      return state.merge((_state$merge3 = {}, _defineProperty(_state$merge3, opts.isError, (0, _immutable.fromJS)(action.payload)), _defineProperty(_state$merge3, opts.isLoading, false), _defineProperty(_state$merge3, opts.isSaving, false), _defineProperty(_state$merge3, opts.isFinished, true), _defineProperty(_state$merge3, opts.data, null), _defineProperty(_state$merge3, opts.queryResult, isFind ? null : state[opts.queryResult] || null), _state$merge3));
    }), _ref;
  };
  ...
  return {
    ...
    _defineProperty({}, RESET, function (state, action) {
      ...
      return _extends({}, state, (_extends2 = {}, _defineProperty(_extends2, opts.isError, null), _defineProperty(_extends2, opts.isLoading, false), _defineProperty(_extends2, opts.isSaving, false), _defineProperty(_extends2, opts.isFinished, false), _defineProperty(_extends2, opts.data, null), _defineProperty(_extends2, opts.queryResult, action.payload ? state[opts.queryResult] : null), _extends2));
    })), (0, _immutable.Map)((_Map = {}, _defineProperty(_Map, opts.isError, null), _defineProperty(_Map, opts.isLoading, false), _defineProperty(_Map, opts.isSaving, false), _defineProperty(_Map, opts.isFinished, false), _defineProperty(_Map, opts.data, null), _defineProperty(_Map, opts.queryResult, null), _Map)))
  };
};
